<?php /* Smarty version 2.6.11, created on 2014-10-31 12:48:20
         compiled from cache/modules/Accounts/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Accounts/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/Accounts/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/Accounts/SearchForm_advanced.tpl', 44, false),array('function', 'html_options', 'cache/modules/Accounts/SearchForm_advanced.tpl', 335, false),array('function', 'sugar_getimage', 'cache/modules/Accounts/SearchForm_advanced.tpl', 463, false),array('modifier', 'default', 'cache/modules/Accounts/SearchForm_advanced.tpl', 471, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='lead_source_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LEAD_SOURCE','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'lead_source_c_advanced','name' => 'lead_source_c_advanced[]','options' => $this->_tpl_vars['fields']['lead_source_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['lead_source_c_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='account_status_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_STATUS','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'account_status_c_advanced','name' => 'account_status_c_advanced[]','options' => $this->_tpl_vars['fields']['account_status_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['account_status_c_advanced']['value']), $this);?>
