<?php /* Smarty version 2.6.11, created on 2014-11-06 12:33:16
         compiled from cache/modules/Leads/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Leads/EditView.tpl', 48, false),array('function', 'counter', 'cache/modules/Leads/EditView.tpl', 54, false),array('function', 'sugar_getimagepath', 'cache/modules/Leads/EditView.tpl', 57, false),array('function', 'sugar_translate', 'cache/modules/Leads/EditView.tpl', 60, false),array('function', 'html_options', 'cache/modules/Leads/EditView.tpl', 77, false),array('function', 'sugar_getjspath', 'cache/modules/Leads/EditView.tpl', 249, false),array('function', 'sugar_getimage', 'cache/modules/Leads/EditView.tpl', 972, false),array('modifier', 'default', 'cache/modules/Leads/EditView.tpl', 53, false),array('modifier', 'strip_semicolon', 'cache/modules/Leads/EditView.tpl', 71, false),array('modifier', 'lookup', 'cache/modules/Leads/EditView.tpl', 510, false),array('modifier', 'count', 'cache/modules/Leads/EditView.tpl', 590, false),)), $this); ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_BIRTHDATE','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_GENDER','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php endif; ?>
<td valign="top" id='accounttype_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNTTYPE','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['accounttype_c']['value'] ) && $this->_tpl_vars['fields']['accounttype_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['accounttype_c']['options'],'selected' => $this->_tpl_vars['fields']['accounttype_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['accounttype_c']['options'],'selected' => $this->_tpl_vars['fields']['accounttype_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['accounttype_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['accounttype_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['accounttype_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['accounttype_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['accounttype_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['accounttype_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['accounttype_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['accounttype_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['accounttype_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
addToValidate(\'EditView\', \'status\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Leads','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'memberid_c\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MEMBERID','module' => 'Leads','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'gender_c\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_GENDER','module' => 'Leads','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'accounttype_c\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNTTYPE','module' => 'Leads','for_js' => true), $this); echo '\' );
