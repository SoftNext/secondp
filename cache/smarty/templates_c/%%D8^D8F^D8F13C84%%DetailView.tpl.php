<?php /* Smarty version 2.6.11, created on 2014-10-13 14:15:47
         compiled from cache/modules/Cases/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Cases/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/Cases/DetailView.tpl', 38, false),array('function', 'sugar_getimagepath', 'cache/modules/Cases/DetailView.tpl', 41, false),array('function', 'sugar_translate', 'cache/modules/Cases/DetailView.tpl', 44, false),array('function', 'sugar_ajax_url', 'cache/modules/Cases/DetailView.tpl', 144, false),array('modifier', 'strip_semicolon', 'cache/modules/Cases/DetailView.tpl', 58, false),array('modifier', 'escape', 'cache/modules/Cases/DetailView.tpl', 227, false),array('modifier', 'url2html', 'cache/modules/Cases/DetailView.tpl', 227, false),array('modifier', 'nl2br', 'cache/modules/Cases/DetailView.tpl', 227, false),)), $this); ?>
...
<td width='37.5%' colspan='3' >
<?php if (! $this->_tpl_vars['fields']['subject_type_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['subject_type_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['subject_type_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['subject_type_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['subject_type_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['subject_type_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['subject_type_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['subject_type_c']['options'][$this->_tpl_vars['fields']['subject_type_c']['value']]; ?>
