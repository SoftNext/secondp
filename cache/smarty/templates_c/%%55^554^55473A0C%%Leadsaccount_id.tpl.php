...
<?php if (strlen ( $this->_tpl_vars['fields']['account_id']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['account_id']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['account_id']['value']);  endif; ?>  
