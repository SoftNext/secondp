<?php /* Smarty version 2.6.11, created on 2013-10-16 18:33:38
         compiled from modules/Campaigns/tpls/WizardCampaignTracker.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/Campaigns/tpls/WizardCampaignTracker.tpl', 128, false),array('function', 'sugar_getimage', 'modules/Campaigns/tpls/WizardCampaignTracker.tpl', 129, false),)), $this); ?>
...
">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		<th colspan="4" align="left" ><h4><?php echo $this->_tpl_vars['MOD']['LBL_WIZ_NEWSLETTER_TITLE_STEP3']; ?>
</h4></th>
		</tr>
...
<br></td><td>&nbsp;</td></tr>
	...
	<div id='tracker_input_div'>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		<td width="15%" scope="row"><slot><?php echo $this->_tpl_vars['MOD']['LBL_EDIT_TRACKER_NAME']; ?>
<span class="required">&nbsp;</span></slot></td>
		<td width="25%" ><slot><input id="tracker_name" type="text" size="30" name="tracker_name" title="<?php echo $this->_tpl_vars['MOD']['LBL_EDIT_TRACKER_NAME']; ?>
" value="<?php echo $this->_tpl_vars['TRACKER_NAME']; ?>
"></slot></td>
		<td width="25%" scope="row"><slot><input onclick="toggle_tracker_url(this);" name="is_optout" title="<?php echo $this->_tpl_vars['MOD']['LBL_EDIT_OPT_OUT']; ?>
" id="is_optout"  class="checkbox" type="checkbox" />&nbsp;<?php echo $this->_tpl_vars['MOD']['LBL_EDIT_OPT_OUT_']; ?>
</slot></td>
	    <td width="35%" ><slot>&nbsp;</slot></td>
		</tr>
		<tr>
		<td scope="row"><slot><?php echo $this->_tpl_vars['MOD']['LBL_EDIT_TRACKER_URL']; ?>
&nbsp;<span class="required"></span></slot></td>
		<td  colspan=3><slot><input type="text" size="80" maxlength='255' <?php echo $this->_tpl_vars['TRACKER_URL_DISABLED']; ?>
	...
	<table width='100%' border="0" cellspacing="0" cellpadding="0">
		...
		<tr><td class='list view'>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr >
			    <th width='15%' scope="col" nowrap><?php echo $this->_tpl_vars['MOD']['LBL_EDIT_OPT_OUT']; ?>
</th>
				<th width='40%' scope="col"><?php echo $this->_tpl_vars['MOD']['LBL_EDIT_TRACKER_NAME']; ?>
</th>
			    <th width='45%' scope="col" colspan="2"><?php echo $this->_tpl_vars['MOD']['LBL_EDIT_TRACKER_URL']; ?>
</th>
		    </tr>
			</table>
