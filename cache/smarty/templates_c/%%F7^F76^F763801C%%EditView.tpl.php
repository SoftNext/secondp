<?php /* Smarty version 2.6.11, created on 2014-11-01 13:35:11
         compiled from cache/modules/Accounts/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Accounts/EditView.tpl', 44, false),array('function', 'counter', 'cache/modules/Accounts/EditView.tpl', 50, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/EditView.tpl', 53, false),array('function', 'sugar_translate', 'cache/modules/Accounts/EditView.tpl', 56, false),array('function', 'sugar_getjspath', 'cache/modules/Accounts/EditView.tpl', 152, false),array('function', 'html_options', 'cache/modules/Accounts/EditView.tpl', 407, false),array('function', 'sugar_getimage', 'cache/modules/Accounts/EditView.tpl', 1300, false),array('modifier', 'default', 'cache/modules/Accounts/EditView.tpl', 49, false),array('modifier', 'strip_semicolon', 'cache/modules/Accounts/EditView.tpl', 67, false),array('modifier', 'lookup', 'cache/modules/Accounts/EditView.tpl', 432, false),array('modifier', 'count', 'cache/modules/Accounts/EditView.tpl', 512, false),)), $this); ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='memberid_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_MEMBERID','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
<td valign="top" id='account_status_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_STATUS','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['account_status_c']['value'] ) && $this->_tpl_vars['fields']['account_status_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['account_status_c']['options'],'selected' => $this->_tpl_vars['fields']['account_status_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['account_status_c']['options'],'selected' => $this->_tpl_vars['fields']['account_status_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['account_status_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['account_status_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['account_status_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['account_status_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['account_status_c']['name'];  echo ' = function(){
SyncToHidden();
}
...
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['account_status_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['account_status_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php endif; ?>
<td valign="top" id='onlineaccountstatus_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ONLINEACCOUNTSTATUS','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['onlineaccountstatus_c']['value'] ) && $this->_tpl_vars['fields']['onlineaccountstatus_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['onlineaccountstatus_c']['options'],'selected' => $this->_tpl_vars['fields']['onlineaccountstatus_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['onlineaccountstatus_c']['options'],'selected' => $this->_tpl_vars['fields']['onlineaccountstatus_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['onlineaccountstatus_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['onlineaccountstatus_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='account_subtype_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_SUBTYPE','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['account_subtype_c']['value'] ) && $this->_tpl_vars['fields']['account_subtype_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['account_subtype_c']['options'],'selected' => $this->_tpl_vars['fields']['account_subtype_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['account_subtype_c']['options'],'selected' => $this->_tpl_vars['fields']['account_subtype_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['account_subtype_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['account_subtype_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['account_subtype_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['account_subtype_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['account_subtype_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['account_subtype_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['account_subtype_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['account_subtype_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='member_signupdate_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_MEMBER_SIGNUPDATE','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<span class="dateTime">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['member_signupdate_c']['value']); ?>
<input class="date_input" autocomplete="off" type="text" name="<?php echo $this->_tpl_vars['fields']['member_signupdate_c']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['member_signupdate_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['date_value']; ?>
" title=''  tabindex='0'    size="11" maxlength="10" >
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['member_signupdate_c']['name']; ?>
...
<script type="text/javascript">
Calendar.setup ({
inputField : "<?php echo $this->_tpl_vars['fields']['member_signupdate_c']['name']; ?>
",
form : "EditView",
...
",
button : "<?php echo $this->_tpl_vars['fields']['member_signupdate_c']['name']; ?>
_trigger",
singleClick : true,
...
<td valign="top" id='member_joindate_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_MEMBER_JOINDATE','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<span class="dateTime">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['member_joindate_c']['value']); ?>
<input class="date_input" autocomplete="off" type="text" name="<?php echo $this->_tpl_vars['fields']['member_joindate_c']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['member_joindate_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['date_value']; ?>
" title=''  tabindex='0'    size="11" maxlength="10" >
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['member_joindate_c']['name']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'other_attributes' => ($this->_tpl_vars['other_attributes'])), $this);?>

</span>
<script type="text/javascript">
Calendar.setup ({
inputField : "<?php echo $this->_tpl_vars['fields']['member_joindate_c']['name']; ?>
",
form : "EditView",
ifFormat : "<?php echo $this->_tpl_vars['CALENDAR_FORMAT']; ?>
",
daFormat : "<?php echo $this->_tpl_vars['CALENDAR_FORMAT']; ?>
",
button : "<?php echo $this->_tpl_vars['fields']['member_joindate_c']['name']; ?>
_trigger",
singleClick : true,
dateStr : "<?php echo $this->_tpl_vars['date_value']; ?>
",
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_LEAD_SOURCE','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['lead_source_c']['value'] ) && $this->_tpl_vars['fields']['lead_source_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['lead_source_c']['options'],'selected' => $this->_tpl_vars['fields']['lead_source_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['lead_source_c']['options'],'selected' => $this->_tpl_vars['fields']['lead_source_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['lead_source_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['lead_source_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['lead_source_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['lead_source_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['lead_source_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['lead_source_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['lead_source_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['lead_source_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
addToValidate(\'EditView\', \'account_type\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'Accounts','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'member_signupdate_c\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MEMBER_SIGNUPDATE','module' => 'Accounts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'member_joindate_c\', \'date\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MEMBER_JOINDATE','module' => 'Accounts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'account_subtype_c\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_SUBTYPE','module' => 'Accounts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'memberid_c\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MEMBERID','module' => 'Accounts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'account_status_c\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_STATUS','module' => 'Accounts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'lead_source_c\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LEAD_SOURCE','module' => 'Accounts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'onlineaccountstatus_c\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ONLINEACCOUNTSTATUS','module' => 'Accounts','for_js' => true), $this); echo '\' );
