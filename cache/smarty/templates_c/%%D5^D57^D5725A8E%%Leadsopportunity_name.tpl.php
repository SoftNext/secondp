...
<?php if (strlen ( $this->_tpl_vars['fields']['opportunity_name']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['opportunity_name']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['opportunity_name']['value']);  endif; ?>  
