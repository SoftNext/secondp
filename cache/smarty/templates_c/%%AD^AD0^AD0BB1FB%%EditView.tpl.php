<?php /* Smarty version 2.6.11, created on 2014-10-13 15:08:05
         compiled from cache/modules/Tasks/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Tasks/EditView.tpl', 45, false),array('function', 'counter', 'cache/modules/Tasks/EditView.tpl', 51, false),array('function', 'sugar_getimagepath', 'cache/modules/Tasks/EditView.tpl', 54, false),array('function', 'sugar_translate', 'cache/modules/Tasks/EditView.tpl', 57, false),array('function', 'html_options', 'cache/modules/Tasks/EditView.tpl', 101, false),array('function', 'sugar_getimage', 'cache/modules/Tasks/EditView.tpl', 325, false),array('function', 'sugar_getjspath', 'cache/modules/Tasks/EditView.tpl', 353, false),array('modifier', 'default', 'cache/modules/Tasks/EditView.tpl', 50, false),array('modifier', 'strip_semicolon', 'cache/modules/Tasks/EditView.tpl', 68, false),array('modifier', 'lookup', 'cache/modules/Tasks/EditView.tpl', 126, false),array('modifier', 'count', 'cache/modules/Tasks/EditView.tpl', 206, false),)), $this); ?>
...
<script type="text/javascript">
addForm(\'EditView\');addToValidate(\'EditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'status\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_due_flag\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_DUE_FLAG','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_due_date\', \'date\', false,\'Due Date\' );
addToValidate(\'EditView\', \'time_due_date\', \'date\', false,\'Due Time\' );
addToValidate(\'EditView\', \'date_start_flag\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_START_FLAG','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_start_date\', \'date\', false,\'Start Date\' );
addToValidateDateBefore(\'EditView\', \'date_start\', \'datetimecombo\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_START_DATE','module' => 'Tasks','for_js' => true), $this); echo '\', \'date_due\' );
addToValidate(\'EditView\', \'parent_type\', \'parent_type\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PARENT_NAME','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'parent_name\', \'parent\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_RELATED_TO','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'parent_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PARENT_ID','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'contact_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_ID','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'contact_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_NAME','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'contact_phone\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_PHONE','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'contact_email\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_ADDRESS','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'priority\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIORITY','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidateBinaryDependency(\'EditView\', \'assigned_user_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Tasks','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Tasks','for_js' => true), $this); echo '\', \'assigned_user_id\' );
addToValidateBinaryDependency(\'EditView\', \'contact_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Tasks','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_NAME','module' => 'Tasks','for_js' => true), $this); echo '\', \'contact_id\' );
