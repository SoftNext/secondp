...
{/if} 
<span class="sugar_field" id="{$fields.memberid_c.name}">{$fields.memberid_c.value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.onlineaccountstatus_c.hidden}
...
{if is_string($fields.onlineaccountstatus_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.onlineaccountstatus_c.name}" value="{ $fields.onlineaccountstatus_c.options }">
{ $fields.onlineaccountstatus_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.onlineaccountstatus_c.name}" value="{ $fields.onlineaccountstatus_c.value }">
{ $fields.onlineaccountstatus_c.options[$fields.onlineaccountstatus_c.value]}
{/if}
{/if}
</td>
</tr>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.member_signupdate_c.hidden}
...
{if strlen($fields.member_signupdate_c.value) <= 0}
{assign var="value" value=$fields.member_signupdate_c.default_value }
{else}
{assign var="value" value=$fields.member_signupdate_c.value }
{/if}
<span class="sugar_field" id="{$fields.member_signupdate_c.name}">{$value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.member_joindate_c.hidden}
...
{if strlen($fields.member_joindate_c.value) <= 0}
{assign var="value" value=$fields.member_joindate_c.default_value }
{else}
{assign var="value" value=$fields.member_joindate_c.value }
{/if}
<span class="sugar_field" id="{$fields.member_joindate_c.name}">{$value}</span>
{/if}
</td>
</tr>
{/capture}
