...
{capture name="label" assign="label"}{sugar_translate label='LBL_MEMBERID' module='Accounts'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
id='{$fields.memberid_c.name}' size='30' 
maxlength='7' 
value='{$value}' title=''      >
...
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.account_status_c.name}-input', '{$fields.account_status_c.name}');sync_{$fields.account_status_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ONLINEACCOUNTSTATUS' module='Accounts'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.onlineaccountstatus_c.name}" 
id="{$fields.onlineaccountstatus_c.name}" 
title=''       
>
{if isset($fields.onlineaccountstatus_c.value) && $fields.onlineaccountstatus_c.value != ''}
{html_options options=$fields.onlineaccountstatus_c.options selected=$fields.onlineaccountstatus_c.value}
{else}
{html_options options=$fields.onlineaccountstatus_c.options selected=$fields.onlineaccountstatus_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.onlineaccountstatus_c.options }
{capture name="field_val"}{$fields.onlineaccountstatus_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.onlineaccountstatus_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.onlineaccountstatus_c.name}" 
id="{$fields.onlineaccountstatus_c.name}" 
title=''          
>
{if isset($fields.onlineaccountstatus_c.value) && $fields.onlineaccountstatus_c.value != ''}
...
<input
id="{$fields.onlineaccountstatus_c.name}-input"
name="{$fields.onlineaccountstatus_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.onlineaccountstatus_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.onlineaccountstatus_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.onlineaccountstatus_c.name}-input', '{$fields.onlineaccountstatus_c.name}');sync_{$fields.onlineaccountstatus_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.onlineaccountstatus_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.onlineaccountstatus_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.onlineaccountstatus_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.onlineaccountstatus_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.onlineaccountstatus_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.onlineaccountstatus_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.onlineaccountstatus_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.onlineaccountstatus_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.onlineaccountstatus_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MEMBER_SIGNUPDATE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<span class="dateTime">
{assign var=date_value value=$fields.member_signupdate_c.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.member_signupdate_c.name}" id="{$fields.member_signupdate_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.member_signupdate_c.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.member_signupdate_c.name}",
form : "EditView",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.member_signupdate_c.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MEMBER_JOINDATE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
<span class="dateTime">
{assign var=date_value value=$fields.member_joindate_c.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.member_joindate_c.name}" id="{$fields.member_joindate_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.member_joindate_c.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.member_joindate_c.name}",
form : "EditView",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.member_joindate_c.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
startWeekday: {$CALENDAR_FDOW|default:'0'},
step : 1,
...
{capture name="label" assign="label"}{sugar_translate label='LBL_LEAD_SOURCE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.lead_source_c.name}" 
id="{$fields.lead_source_c.name}" 
title=''       
>
{if isset($fields.lead_source_c.value) && $fields.lead_source_c.value != ''}
{html_options options=$fields.lead_source_c.options selected=$fields.lead_source_c.value}
{else}
{html_options options=$fields.lead_source_c.options selected=$fields.lead_source_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.lead_source_c.options }
{capture name="field_val"}{$fields.lead_source_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.lead_source_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.lead_source_c.name}" 
id="{$fields.lead_source_c.name}" 
title=''          
>
{if isset($fields.lead_source_c.value) && $fields.lead_source_c.value != ''}
...
<input
id="{$fields.lead_source_c.name}-input"
name="{$fields.lead_source_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.lead_source_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.lead_source_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.lead_source_c.name}-input', '{$fields.lead_source_c.name}');sync_{$fields.lead_source_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.lead_source_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.lead_source_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.lead_source_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.lead_source_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.lead_source_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.lead_source_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.lead_source_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.lead_source_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.lead_source_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
addToValidate('EditView', 'account_type', 'enum', true,'{/literal}{sugar_translate label='LBL_TYPE' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'member_signupdate_c', 'date', false,'{/literal}{sugar_translate label='LBL_MEMBER_SIGNUPDATE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'member_joindate_c', 'date', true,'{/literal}{sugar_translate label='LBL_MEMBER_JOINDATE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'account_subtype_c', 'enum', true,'{/literal}{sugar_translate label='LBL_ACCOUNT_SUBTYPE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'memberid_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_MEMBERID' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'account_status_c', 'enum', true,'{/literal}{sugar_translate label='LBL_ACCOUNT_STATUS' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'lead_source_c', 'enum', true,'{/literal}{sugar_translate label='LBL_LEAD_SOURCE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'onlineaccountstatus_c', 'enum', true,'{/literal}{sugar_translate label='LBL_ONLINEACCOUNTSTATUS' module='Accounts' for_js=true}{literal}' );
