...
<input type='text' name='{$fields.address_postalcode_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='lead_source_c_advanced'>{sugar_translate label='LBL_LEAD_SOURCE' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='lead_source_c_advanced' name='lead_source_c_advanced[]' options=$fields.lead_source_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.lead_source_c_advanced.value}
   	   	</td>
...
{html_options id='account_type_advanced' name='account_type_advanced[]' options=$fields.account_type_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.account_type_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='account_status_c_advanced'>{sugar_translate label='LBL_ACCOUNT_STATUS' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='account_status_c_advanced' name='account_status_c_advanced[]' options=$fields.account_status_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.account_status_c_advanced.value}
   	   	</td>
