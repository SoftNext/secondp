...
addToValidate('form_SubpanelQuickCreate_Contacts', 'account_subtype_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_ACCOUNT_SUBTYPE' module='Contacts' for_js=true}{literal}' );
