...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.subject_type_c.hidden}
...
{if is_string($fields.subject_type_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.subject_type_c.name}" value="{ $fields.subject_type_c.options }">
{ $fields.subject_type_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.subject_type_c.name}" value="{ $fields.subject_type_c.value }">
{ $fields.subject_type_c.options[$fields.subject_type_c.value]}
{/if}
{/if}
</td>
</tr>
