...
addToValidate('form_SubpanelQuickCreate_Cases', 'status', 'enum', false,'{/literal}{sugar_translate label='LBL_STATUS' module='Cases' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Cases', 'subject_type_c', 'enum', true,'{/literal}{sugar_translate label='LBL_SUBJECT_TYPE' module='Cases' for_js=true}{literal}' );
